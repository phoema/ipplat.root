...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			containerBorderSize:	40,			// (integer) If you adjust the padding in the CSS for the container, #lightbox-container-image-box, you will need to update this value
			containerResizeSpeed:	400,		// (integer) Specify the resize duration of container image. These number are miliseconds. 400 is default.
			// Configuration related to texts in caption. For example: Image 2 of 8. You can alter either "Image" and "of" texts.
			txtImage:				'附图',	// (string) Specify text "Image"
		...
		function _set_image_to_view() { // show the loading
			...
			objImagePreloader.onload = function() {
				...
				_resize_container_image_box(me.width(),me.height());
				});
		...
		function _resize_container_image_box(intImageWidth,intImageHeight) {
			...
			$('#lightbox-container-image-box').animate({ width: intWidth, height: intHeight-30 },settings.containerResizeSpeed,function() { _show_image(); });
