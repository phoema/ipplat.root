 ...
 */
 (function($){
	...
	var containers = this,
		...
		links = renderer.getLinks(current_page, pageSelected);
		if(opts.disGo){
			links.append("<a class='goBtn' onclick='goPage4Click(this,"+maxentries+");' href='#' title='跳转到指定的页码'>转到</a>");
			links.append("<input type='text' id='gopagePagination' style='width:25px' value='' onkeydown='goPage4EnterKey(this,"+maxentries+");'/>页");
		}
		containers.empty();
		links.appendTo(containers);
		// Generate "Goto"-Link
