(function() {
	$.extend($.fn, {
		mask: function(msg, maskDivClass,winHeight) {
			...
			if (msg) {
				var msgDiv = $('<div style="position:absolute;border:#6593cf 1px solid; padding:1px;background:#ccca"><div style="line-height:24px;border:#a3bad9 1px solid;background:white;padding:2px 10px 2px 10px"><img align="absMiddle" src="'+_RootUrl +'images/ajax-loader16x16.gif"/>&nbsp;' + msg + '</div></div>');
