				 ...
				 if(objrecord!==undefined&&objrecord!='undefined'){
					 ...
					 for(var i=0;i<objrecord.length;i++){ 
						 ...
						 /*处理法律状态start*/
				     	 ...
				     	 str+='<div class="secondDiv ng-scope" ng-repeat="patent in data" style="white-space:nowrap">';
						   str+='<div class="marginTop10 displayInline positionRelative" style="width:70%; height:auto!important; height:220px; min-height:220px;">';
						   str+='<div style="dispaly:inline; width:100%;"><div class="displayInline title marginLeft40px titleDiv" style="float:Left">';
						   ...
						   str+=objrecord[i].TIO+'</a></div>';          
						   str+='<div class="displayInline" style="float:right;">';           
						   str+='<a class="btntextalink TIChighlight account_state_1_link _link" >';               
						   str+='<div class="lssc2 iconFirst displayInline statusPatent">'+fixstate(objrecord[i].LSSC)+'</div></a>';        
						   str+='<div class="pdt2 iconSecond displayInline statusPatent" style="background-color:#648bcf;">'+objrecord[i].PDT+'</div>';               
						   str+='</div></div>';               
						   str+='<div class="PIDCNY020020918000000000025120FCF0AJ3JB014094_ti_cn title titleEnglishDiv signFilter marginLeft40px displaynnnn imgContentLighHight TIEhighlight" style="font-size: 13px; color: rgb(100, 139, 207); display: none;">';               
						   str+='<strong class="highlight">计算机</strong>机箱</div>';                
						   str+='<div class="PIDCNY020020918000000000025120FCF0AJ3JB014094_ti_en title titleEnglishDiv signFilter marginLeft40px displaynnnn imgContentLighHight TIEhighlight" style="font-size: 13px; color: rgb(100, 139, 207); display: none;">Computer housing</div>';             
						   ...
						   str+='<a  href="javascript:void(0);" class="signFilter TIChighlight languageSelectField account_state_1_link _link ng-binding">'+objrecord[i].PNO+'</a></div>';                
						   ...
						   str+='<a href="javascript:void(0)" >'+objrecord[i].APO+'</a></div></div>';                
						   ...
						   if(objrecord[i].PDT=="外观设计"){
							   ...
							   str+='<div class="displayInline arial blue neirong LJNQLink ng-binding">'+fixnull(objrecord[i].LC)+'</div></div>';              
								  ...
								  str+='<div class="ipc2 marginleft imgContentLighHight">';                
								   ...
								   str+='<div class="displayInline arial blue neirong IPCQLink ng-binding"><a href="javascript:void(0);">'+fixnull(objrecord[i].IPC)+'</a></div></div>';               
							 }
...
//						   str+='<img style="width:936px; height:848px;" class="borderD3Radius2 bigImgDisplay" title="缩略图" src="images/THB_006.GIeF"></div>';
//						   str+='</div><div class="small cursorPointer">';   
//						   str+='<span style="left: 135.467px; top: 0px; display: none;" v="http://image.zldsj.com/H/PID/CNY0/2002/0918/00000000002512/0FCF0AJ3JB014094/THB/THB.GIF" class="mark"></span>';    
//						   str+='<img onclick="tobig()" alt="缩略图" style="width:214px; height:194px;" title="缩略图" src="'+objrecord[i].src+'" class="im1 smallImgDisplay"></div>';   
//						   str+='</div></div>';
//						   str+='<hr style=" margin: 0px; margin-left: 30px; margin-right:30px; margin-top:0px; border-width: 1px; border-color:#999999;">';   
//						   str+='</div></div> ';   
						   ...
						   if(objrecord[i].PDT=="外观设计"){
							   ...
							   str+='<img style="width:936px; height:848px;" class="borderD3Radius2 bigImgDisplay" title="缩略图" src="images/THB_006.GIeF"></div>';
							   str+='</div><div class="small cursorPointer">';   
							   str+='<span style="left: 135.467px; top: 0px; display: none;" v="http://image.zldsj.com/H/PID/CNY0/2002/0918/00000000002512/0FCF0AJ3JB014094/THB/THB.GIF" class="markkk"></span>';    
							   str+='<img onclick="tobig(this,\''+objrecord[i].src+'\')" alt="缩略图" style="width:214px; height:194px;" title="缩略图" src="'+objrecord[i].src+'" class="im1 smallImgDisplay"></div>';   
							   str+='</div></div>';
							   str+='</div></div></div> ';
							   str+='<hr style="  border-width: 1px; border-color:#3b4a82; clear:both; width:100%">';   
						   }else{
