var freezeTxnAction = "PatentTableSea";
...
$(document).ready(function() {
	...
	$(".seaInput,.seaInput2").blur(function() {
		...
		if (jg.length == 0) {
			...
			if (exp == "" && freezeTxnAction != "DecisionTable" && freezeTxnAction != "RefereeTable" && freezeTxnAction != "LawsTable") {
...
//					type : "POST",
//					dataType : "xml",
//					url : "/" + rootPath +"dddd"+ preQueryAction,
...
//			}
	...
	// 预检索删除按钮
	// 输入框清空按钮
	$(".inputClear").attr("src", "/" + rootPath + "IPOperate/html/search/images/inputClear.png");
	// 清空输入内容
