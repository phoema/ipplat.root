...
// layer.alert('preCheckExpress***'+finalex);
  ...
  window.location.href="resultlist.htm?ex="+encodeURIComponent(finalex);
...
function showdiv(){
	 var _ww = $(window).width();
	    ...
	    var divh = $("#LocanoWindow").height() + 213;
	    var mincontenth = $("body").height() + 213;
	    var wh = '';
	    if (mincontenth > divh) {
	        wh = mincontenth + 213;
	    } else {
	   ...
	   // var wh = $("#showdiv").height() + 213;
	    $("#div_float_show").css("height", wh + "px").css("width", ws + "px").css({ top: "0px", left: "0px" }).show();
}
function c2eclick(e){    
/*切换成英文*/ 
	var windowFormId = $(e).attr("v");
