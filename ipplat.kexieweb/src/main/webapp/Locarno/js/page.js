...
function getsbPage(totalcount, currentpage,ex) {  
    ...
    if (currentpage > 1 && _totalCount > 0 && currentpage <= pageCount) {
    	var pageint=parseInt(currentpage)-1;
        var $img1 = $('&nbsp;<a href="javascript:void(0)" onclick="getsblist(\''+ex+'\',\'1\')">首页</a><a href="javascript:void(0)" onclick="getsblist(\''+ex+'\',\''+pageint+'\')">上一页</a>');
        $img1.appendTo($div);
    } //w_s"首页"去掉span 
    //2~15 全显示
    if (pageCount <= 15 && pageCount > 1) { 
        for (var i = 0; i < pageCount; i++) {
            ...
            if(currentpage == (i + 1)){ 
            	 ...
            	 $div1 = $('&nbsp;<a href="javascript:void(0)" onclick="getsblist(\''+ex+'\',\''+(i+1)+'\')">'+(i + 1)+'</a>');
            }
    ...
    if (currentpage < pageCount) {
    	var pageint=parseInt(currentpage)+1;
    	 var $img1 = $('<a href="javascript:void(0)" onclick="getsblist(\''+ex+'\',\''+pageint+'\')">下一页</a>');
    	 //商标没有最后一页 &nbsp;<a href="javascript:void(0)" onclick="getsblist(\''+ex+'\',\''+pageCount+'\')">最后一页</a>
        $img1.appendTo($div);
...
//专利分页
function getPage(totalcount, currentpage,ex) {  
    ...
    if (currentpage > 1 && _totalCount > 0 && currentpage <= pageCount) {
    	var pageint=parseInt(currentpage)-1;
        var $img1 = $('&nbsp;<a href="javascript:void(0)" onclick="getlist(\''+ex+'\',\'1\')">首页</a><a href="javascript:void(0)" onclick="getlist(\''+ex+'\',\''+pageint+'\')">上一页</a>');
        $img1.appendTo($div);
    } //w_s"首页"去掉span 
    //2~15 全显示
    if (pageCount <= 15 && pageCount > 1) { 
        for (var i = 0; i < pageCount; i++) {
            ...
            if(currentpage == (i + 1)){ 
            	 ...
            	 $div1 = $('&nbsp;<a href="javascript:void(0)" onclick="getlist(\''+ex+'\',\''+(i+1)+'\')">'+(i + 1)+'</a>');
            }
    ...
    if (currentpage < pageCount) {
    	var pageint=parseInt(currentpage)+1;
    	 var $img1 = $('<a href="javascript:void(0)" onclick="getlist(\''+ex+'\',\''+pageint+'\')">下一页</a>');
        $img1.appendTo($div);
