...
function tradeMarkLibContr_delete(obj, ids) {
...
function ameclick(e){
	if (!$(e).prop("checked")){
		$('#leisi').css("background-color", "#fff").css("color", "#555555").attr("disabled", false);	
		
	}else{
		$('#leisi').css("background-color", "#999").css("color", "#fff").attr("disabled", true).val("");
...
//马德里点击事件
function madlclick(e){
	if (!$(e).prop("checked")){
		$('#leisi').css("background-color", "#fff").css("color", "#555555").attr("disabled", false);	
		$('#shnqing').css("background-color", "#fff").css("color", "#555555").attr("disabled", false);
	}else{
		$('#leisi').css("background-color", "#999").css("color", "#fff").attr("disabled", true).val("");
		$('#shnqing').css("background-color", "#999").css("color", "#fff").attr("disabled", true).val("");
	}
