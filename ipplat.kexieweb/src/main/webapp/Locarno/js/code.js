...
var patentLibsCat = {
	...
	"台湾" : [ "发明申请", "发明授权", "实用新型申请", "实用新型授权", "外观设计" ],
	"香港" : ["发明申请", "发明授权"],
	"阿根廷" :["专利"],
	"奥地利" : ["专利"],
	...
	"日本" : [ "发明申请", "发明授权", "实用新型申请", "实用新型授权", "外观设计" ],
...
var trsKeyWord = [ "AB", "ABF", "ADJ", "ALL", "ALLBT", "ALLNT", "AMB", "AT", "AVG", "BETWEEN", "BEYOND", "BT", "CASE", "COUNT", "DATA", "DOCID", "EQU", "EXACT", "INCLUDE", "LE", "LIFO", "LIKE",
		"LOWER", "MAX", "MIN", "NEAR", "NT", "PT", "RANGE", "RELEVANCE", "RT", "SPELL", "ST", "SUM", "TO", "TOASCII", "TOCHINESE", "UF", "UPPER" ];
...
var trsSpField = [ "申请号", "公布号", "优先权", "最早优先权", "国际申请", "国家公布", "简单同族", "引证文献", "分类号", "IPC", "CPC", "FI", "FTERM", "UC", "洛迦诺", "注册号", "申请号", "尼斯分类", "类似群号", "标准号", "标准号冗余", "中国标准分类号CCS",
		"国际标准分类号ICS", "中图分类", "ASJC分类", "学科分类", "JCR分类", "CJCR分类", "决定号", "专利申请号", "IPC", "洛迦诺" ];
