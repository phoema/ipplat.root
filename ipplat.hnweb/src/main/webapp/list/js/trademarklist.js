					...
					var  objrecord=eval( obj.records ); 
					 if(objrecord!==undefined&&objrecord!='undefined'){
						 for(var i=0;i<objrecord.length;i++){ 
							  ...
							  str+='<span style=" width:88%;" class="displayInline NCLink patentfontword ng-binding"><a href="../list/trademarklist.html?ex='+encodeURIComponent(' (尼斯分类 =  ( \''+objrecord[i].nc+'\'))')+'" target="_blank" >'+ objrecord[i].nc+'</a></span>';
							  str+='</td></tr><tr>';
							  ...
							  str+='<a href="../list/trademarklist.html?ex= '+encodeURIComponent('(申请人名称 =  ( \''+objrecord[i].hno+'\'))')+'" target="_blank" style="word-break: break-all; word-wrap: break-word;"  >'+ objrecord[i].hno+'</a></span></td>';
							  str+='</tr><tr><td colspan="2" style="word-break:break-all; word-wrap:break-word; width:540px;" valign="top">';
							  str+='<b>代理人名称：</b><span class="ARLink listHightDiv ng-binding"> <a href="../list/trademarklist.html?ex='+encodeURIComponent(' (代理人名称 =  ( \''+objrecord[i].aro+'\'))')+'" target="_blank">'+ fixnull(objrecord[i].aro)+'</span></td>';
