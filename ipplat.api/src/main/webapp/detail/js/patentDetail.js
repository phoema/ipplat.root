				...
				$('#doPdf').click(function(){
					...
					if(obj.apo!=''){
						...
						for(var i=0;i<apos.length;i++){
							str+='<a href="../list/patentlist.html?ex=申请人=(\''+apos[i]+'\')" target="_blank" >'+apos[i]+'</a>  ';
						}
						$('#sqren').html(str);//申请人
					}
					...
					if(obj.ino!=''){
						...
						for(var i=0;i<inos.length;i++){
							str+='<a href="../list/patentlist.html?ex=发明人=(\''+inos[i]+'\')" target="_blank" >'+inos[i]+'</a>  ';
						}
					...
					if(obj.ipc!=''){
						...
						for(var i=0;i<ipcs.length;i++){
							str+='<a href="../list/patentlist.html?ex=IPC=(\''+ipcs[i]+'\')" target="_blank" >'+ipcs[i]+'</a>  ';
						}
						$('#ipc').html(str);//IPC
					}
					...
					if(obj.lc!=''){
						...
						for(var i=0;i<ljns.length;i++){
							str+='<a href="../list/patentlist.html?ex=洛迦诺=(\''+ljns[i]+'\')" target="_blank" >'+ljns[i]+'</a>  ';
						}
						$('#ljns').html(str);//ljn
					}
					...
					if(!!obj.prno)
						...
						for(var j=0;j<prnos.length;j++){ 
							strprno+='<a  href="../list/patentlist.html?ex= (优先权=  ( \''+prnos[j]+'\' ) )"  style="margin-left:5px;" target="_blank">'+prnos[j]+'</a>';
						} 
						$('#prior').html(strprno); 
						} 
			 
					$('#fayshenqing').html(obj.dppa);//分案原申请
					$('#agency').html('<a  href="../list/patentlist.html?ex= (代理机构=  ( \''+obj.agc+'\' ) )" target="_blank">'+obj.agc+'</a>');//代理机构
					
					if(obj.ag!=''){
						var strags='';
						var ags=obj.ag.split(';'); 
						for(var j=0;j<ags.length;j++){ 
						strags+='<a  href="../list/patentlist.html?ex= (代理人=  ( \''+ags[j]+' \') )"  style="margin-left:5px;" target="_blank">'+ags[j]+'</a>';
						}
						$('#agent').html(strags);
					}
					...
					//国际申请 
					$('#internationapply').html('<a  href="../list/patentlist.html?ex= (国际申请=  ( \''+obj.pctao+'\' ) )"  style="margin-left:5px;" target="_blank">'+obj.pcta+'</a>'); 
					//国际公布
					$('#internationalpub').html('<a  href="../list/patentlist.html?ex= (国际公布=  ( \''+obj.pctpo+'\' ) )"  style="margin-left:5px;" target="_blank">'+obj.pctp+'</a>'); 
