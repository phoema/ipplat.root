...
define(function (require) {
    ...
    var mapParams = {
        ...
        '香港': {
            ...
            getGeoJson: function (callback) {
                require(['./geoJson/320500'], function (md) {
                    callback(decode(md));
                });
            }
        },
        '澳门': {
            ...
            getGeoJson: function (callback) {
                require(['./geoJson/330200'], function (md) {
                    callback(decode(md));
                });
            }
        }, '青岛市': {
            getGeoJson: function (callback) {
                require(['./geoJson/370200'], function (md) {
                    callback(decode(md));
                });
            }
        }, '厦门市': {
            getGeoJson: function (callback) {
                require(['./geoJson/350200'], function (md) {
                    callback(decode(md));
                });
            }
        }, '成都市': {
            getGeoJson: function (callback) {
                require(['./geoJson/510100'], function (md) {
                    callback(decode(md));
                });
            }
        }, '西安市': {
            getGeoJson: function (callback) {
                require(['./geoJson/610100'], function (md) {
                    callback(decode(md));
                });
            }
        }, '长沙市': {
            getGeoJson: function (callback) {
                require(['./geoJson/430100'], function (md) {
                    callback(decode(md));
                });
            }
        }, '郑州市': {
            getGeoJson: function (callback) {
                require(['./geoJson/410100'], function (md) {
                    callback(decode(md));
                });
            }
        } 
