...
SWFUpload.prototype.loadFlash = function () {
    ...
    if (!this.support.loading) {
        this.queueEvent("swfupload_load_failed_handler", ["图片上传功能操作失败，你的Flash Player版本过低，请使用Flash Player 9.028 或其以上版本"]);
        return;
    }
    ...
    if (document.getElementById(this.movieName) !== null) {
        ...
        this.queueEvent("swfupload_load_failed_handler", ["图片上传功能操作失败，请联系网站维护人员"]);
        return;
    }
...
SWFUpload.prototype.flashReady = function () {
    ...
    if (!movieElement) {
        this.debug("图片上传功能操作失败，请联系网站维护人员");
        return;
    }
...
SWFUpload.Console.writeLine = function (message) {
    ...
    try {
        ...
        layer.alert("Exception: " + ex.name + " Message: " + ex.message);
    }
};
