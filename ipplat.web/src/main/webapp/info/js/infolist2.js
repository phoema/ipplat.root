$(function() {
	...
	$(".con_left").find("div").bind(
			"click",
			function() {
				if($(this).hasClass("con_menu")&&$(this).attr("name")=="4"){
					locationwin("infolist2.html?1=1&ty="+ $(this).attr("name"));
				}
				if($(this).hasClass("con_menu")&&$(this).attr("name")=="1"){
					openwin("http://www.scipo.gov.cn/jlhd/zxzx/");
				}
				if($(this).hasClass("con_menu")&&$(this).attr("name")=="2"){
					openwin("http://www.scipo.gov.cn/gpjg/yzzx/");
				}
			});
...
function searchbytitle() {
	...
	if (value == '')
		return;
	locationwin( "infolist2.html?1=1&ty=" + getpathname(1)
