...
import com.dipub.domain.SysPermission;
import com.dipub.domain.SysRole;
import com.dipub.domain.SysUser;
import com.dipub.service.SysPermissionRepository;
import com.dipub.service.SysRoleRepository;
...
//		authorizationInfo.setStringPermissions(stringPermissions);
		if(userInfo.getSysRole() != null){
			authorizationInfo.addRole(userInfo.getSysRole().getRole());
			for(SysPermission p:userInfo.getSysRole().getPermissions()){
				authorizationInfo.addStringPermission(p.getPermission());
			}
		}
//		for(SysRole role:userInfo.getRole()){
//			authorizationInfo.addRole(userInfo.getRole().getRole());
